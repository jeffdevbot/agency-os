...
- `docs/monthly_pnl_implementation_plan.md` — Backfill-first Monthly P&L implementation plan using uploaded Amazon transaction reports first and Windsor settlement ingestion later.

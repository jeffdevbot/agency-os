...
- **Monthly P&L** — `/reports/[clientSlug]/[marketplaceCode]/pnl` finance reporting surface built from uploaded Amazon transaction reports, with a separate import pipeline, ledger model, report service, reconciliation workflow, and user framing distinct from WBR. Current state docs: `docs/monthly_pnl_handoff.md`, `docs/monthly_pnl_implementation_plan.md`.

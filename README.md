...
- **Reports (WBR v2)** — `/reports` (client/marketplace WBR workspace with live Section 1 Windsor business reporting, live Section 2 Amazon Ads reporting, live Section 3 inventory + returns reporting, sync QA, nightly refresh controls, and queued/background Ads backfills via `worker-sync`). Current state docs: `docs/wbr_v2_handoff.md`, `docs/wbr_v2_schema_plan.md`; Windsor ops runbook: `docs/windsor_wbr_ingestion_runbook.md`.
...
- `docs/wbr_v2_handoff.md` — Current WBR v2 shipped state, routes, migrations, queued Amazon Ads sync behavior, and restart context.

...
- **Reports (WBR v2)** — `/reports` (client/marketplace WBR workspace with Section 1 Windsor sync/reporting, Section 2 Amazon Ads sync/reporting, sync QA, nightly refresh controls, and queued/background Ads backfills via `worker-sync`). Current state docs: `docs/wbr_v2_handoff.md`, `docs/wbr_v2_schema_plan.md`; Windsor ops runbook: `docs/windsor_wbr_ingestion_runbook.md`.

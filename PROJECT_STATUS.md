...
- **Current next-session product target:** This Step 3 validation slice is effectively a pass; the next useful work should focus on converting the trusted preview surface into a stronger workbook-prefill / analyst-review loop rather than reopening catalog/model plumbing that is now working.

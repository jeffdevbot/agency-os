...
export async function POST(
  ...
  const payload = (await request.json()) as UnassignPayload;
  ...
  // Update all specified variants to have no group
  ...
  return NextResponse.json({ success: true, unassignedCount: payload.variantIds.length });
}

    ...
    return (
        <div className="border-b border-slate-200 p-6">
            ...
            <p className="text-xs text-slate-600 mb-4">
                Customize how your generated content is formatted.
            </p>
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <label className="text-sm font-medium text-slate-800 cursor-pointer" onClick={() => handleToggle("bulletCapsHeaders")}>
                        ...
                        <div className="mt-2 rounded-lg bg-slate-50 p-3 border border-slate-200">
                            ...
                            <p className="text-xs text-slate-700 font-mono">
                                <span className="font-semibold">UNMATCHED QUALITY:</span> Aluminum wall photo frame available in a variety of sizes. A 0.4" wide and 0.8" deep frame provides a contemporary and sleek look...
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <label className="text-sm font-medium text-slate-800 cursor-pointer" onClick={() => handleToggle("descriptionParagraphs")}>

      ...
      <header className="border-b border-slate-200 bg-white px-6 py-4 shadow-sm">
        <div className="mx-auto flex max-w-6xl items-baseline gap-4">
          <div className="flex items-baseline">
            <span className="text-2xl font-extrabold leading-none text-[#0f172a]">Ecom</span><span className="text-2xl font-extrabold leading-none text-[#0a6fd6]">labs</span>
            <span className="ml-2 text-lg font-semibold leading-none text-slate-600">Tools</span>
          </div>
        </div>
      </header>
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3 w-full mt-2">
                  ...
                  <div className="rounded-2xl bg-white/50 backdrop-blur border border-white/40 shadow-md hover:shadow-xl transition-all hover:-translate-y-0.5 p-8 flex flex-col gap-5 text-left">
                    <div className="flex items-start gap-3">
                      <span className="text-2xl">🔍</span>
                      <div className="space-y-1">
                        <p className="text-lg font-semibold text-[#0f172a]">N-PAT</p>
                        <p className="text-base leading-relaxed text-[#4c576f]">
                          ASIN-only negative targeting with Helium10 enrichment and formatted negatives summary.
                        </p>
                      </div>
                    </div>
                    <Link

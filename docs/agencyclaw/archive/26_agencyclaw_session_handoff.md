...
- PRD source of truth: `docs/agencyclaw/archive/23_agencyclaw_prd.md` version `1.18`.
- Execution source of truth: `docs/agencyclaw/archive/25_agencyclaw_execution_tracker.md`.
...
1. Read these in order:
   - `docs/agencyclaw/archive/25_agencyclaw_execution_tracker.md` (status, commits, next actions)
   - `docs/agencyclaw/archive/24_agencyclaw_implementation_plan.md` (chunk contract)
   - `docs/agencyclaw/archive/23_agencyclaw_prd.md` (behavior/policy decisions)
...
Read:
1) docs/agencyclaw/archive/25_agencyclaw_execution_tracker.md
2) docs/agencyclaw/archive/24_agencyclaw_implementation_plan.md
3) docs/agencyclaw/archive/23_agencyclaw_prd.md
...
## 5. Notes
- Avoid using this file as the execution ledger; use `docs/agencyclaw/archive/25_agencyclaw_execution_tracker.md`.

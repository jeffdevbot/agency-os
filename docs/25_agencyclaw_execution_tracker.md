...
- [x] `20260223000001_agencyclaw_agent_loop_storage_foundation.sql` applied
- [x] `20260223000002_agencyclaw_agent_loop_storage_hardening.sql` applied
...
| C17G | Context skills + retention summaries + rehydration | Codex | in-progress | `8a56c74`, `95dcec1` | Evidence utilities + reader landed; both event-scoped (`ev:run/evt`) and run-scoped (`ev:run`) keys work end-to-end. Run-scope returns aggregate note (up to 10 events, 1000-char cap). Context skills (`lookup_client`, etc.) pending. |
...
- C1 (Agent 1): `backend-core/tests/test_task_list.py` passing (37 tests). Added destination filter fix for list-only ClickUp mappings and trailing punctuation sanitization for client hints.
...
- C2 (Agent 1): `backend-core/tests/test_task_create.py` + `backend-core/tests/test_task_list.py` passing (85 tests total). Includes pending-state guards for both `title` and `confirm_or_details`.
...
- C3/C9 merge (`ec23b78`): `backend-core/tests/test_task_create.py`, `backend-core/tests/test_task_list.py`, `backend-core/tests/test_slack_orchestrator.py`, `backend-core/tests/test_c9b_integration.py`, and `backend-core/tests/test_slack_hardening.py` passing (136 tests total).
...
- C4B/C4C merge (`ee303b5`, `649b6cb`, `753a886`, `1422bdb`): `backend-core/tests/test_c4b_task_create_reliability.py`, `backend-core/tests/test_task_create.py`, and `backend-core/tests/test_task_list.py` passing (100 tests total).
...
- C10B/C10B.5 merge (`647f365`): `backend-core/tests/test_c10b_clarify_persistence.py`, `backend-core/tests/test_conversation_buffer.py`, `backend-core/tests/test_slack_orchestrator.py`, `backend-core/tests/test_task_create.py`, `backend-core/tests/test_task_list.py`, `backend-core/tests/test_c9b_integration.py`, and `backend-core/tests/test_slack_hardening.py` passing (171 tests).
...
- C10F semantic resolver check: `backend-core/tests/test_pending_resolution.py`, `backend-core/tests/test_task_create.py`, `backend-core/tests/test_c10b_clarify_persistence.py`, and `backend-core/tests/test_task_list.py` passing (`131 passed`).
...
- C11A/C11B merge (`8ac34b1`): `backend-core/tests/test_command_center_lookup.py`, `backend-core/tests/test_c11a_command_center_integration.py`, `backend-core/tests/test_c9b_integration.py`, `backend-core/tests/test_task_create.py`, and `backend-core/tests/test_task_list.py` passing (targeted suites green).
...
- C15C validation: `backend-core/tests/test_c9b_integration.py` (41 passed, 1 warning), `backend-core/tests/test_slack_orchestrator.py` (27 passed), `backend-core/tests/test_task_list.py` (37 passed, 1 warning), full suite `906 passed, 0 failed, 1 warning`.
...
- C16A validation: `backend-core/tests/test_task_list.py` + `backend-core/tests/test_c9b_integration.py` + `backend-core/tests/test_slack_orchestrator.py` (`112 passed, 1 warning`), full suite `913 passed, 0 failed, 1 warning`.
- C16A residual risk (resolved in C16B): classifier label naming debt (`weekly_tasks` vs `task_list`) remained after C16A and was addressed in C16B canonicalization.
- C16B canonicalization: deterministic classifier now emits canonical `task_list` intent for task-list asks while DM runtime keeps compatibility handling for legacy `weekly_tasks` labels.
- C16B normalization hardening: task-list skill validation now accepts `window_days` as int or numeric string for both canonical and alias skill IDs; runtime continues bounded normalization (1..365) before range evaluation.
...
- C16B validation: `backend-core/tests/test_task_list.py` + `backend-core/tests/test_slack_orchestrator.py` + `backend-core/tests/test_c9b_integration.py` + `backend-core/tests/test_slack_helpers_unit.py` (`195 passed, 1 warning`), full suite `917 passed, 0 failed, 1 warning`.
